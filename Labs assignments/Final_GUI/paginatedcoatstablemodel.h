#ifndef PAGINATEDCOATSTABLEMODEL_H
#define PAGINATEDCOATSTABLEMODEL_H
...
public:
    PaginatedGenesTableModel(Basket& b, QObject* parent = NULL);
...
#endif // PAGINATEDCOATSTABLEMODEL_H
