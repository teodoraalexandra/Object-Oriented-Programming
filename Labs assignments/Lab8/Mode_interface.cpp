    ...
    if (parameter[0] == "add") {
        try
        {
            if (number_of_parameters != 5) {
                //throw MyException ("Number of parameters is not 4.\n");
            }
        }
        ...
        try
        {
            if (int price_coat = std::atoi(parameter[3].c_str()) && ok == 0) {
                ...
                throw MyException ("Coat has invalid price.\n");
            }
        }
        catch (std::exception &e)
        {
        ...
        try
        {
            if (number_of_parameters != 2) {
                //throw MyException("Number of parameters is not 1.\n");
            }
        }
        catch (std::exception &e)
        {
        ...
        try
        {
            if (number_of_parameters != 1) {
                //throw MyException ("List has no additional parameters.\n");
            }
        }
        catch (std::exception &e)
        {
        ...
        mode_B(fileLocation, mylistLocation, 0, controller.size(), 0, controller, argc, argv);
    }
    else {
